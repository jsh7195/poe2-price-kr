...
**유니크 장비**
유니크 무기 · 유니크 방어구 · 유니크 장신구 · 유니크 플라스크 · 유니크 부적 · 유니크 주얼
...
<sub>그 외 — 앱 검색창에 한글을 입력하면 시세 검색 · 창을 닫아도 트레이에서 계속 실행 · 헤더의 **업데이트** 버튼으로 새 버전 적용 · 시세를 못 불러올 때 하단 **버그 신고** 버튼을 누르면 (개인정보 가린) 오류 로그로 GitHub 신고 페이지가 열립니다.
